...
import CodigoProducao.MockObservadorCarrinho;
...
public class TestaCarrinhoDeCompras {
	...
	@Test
	public void escudaAdicaoDeProduto(){
		MockObservadorCarrinho mock = new MockObservadorCarrinho();
		carrinhoDeCompras.adicionarObservador(mock);
		carrinhoDeCompras.adicionaProduto(new Produto("Camisa","CMS2356",20.00), 2);
		mock.verificaRecebimentoDoProduto("CMS2356",20.00);
	}
}
